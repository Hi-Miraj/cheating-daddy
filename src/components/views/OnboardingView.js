    ...
    renderSlide1() {
        return html`
            <div class="slide slide-1 ${this.currentSlide === 0 ? 'active' : ''}">
                <div class="emoji">👋</div>
                <div class="slide-title">Welcome to Manangry.ai!</div>
                <div class="slide-content">
                    Manangry.ai hears what you hear and sees what you see, then generates AI-powered suggestions without any user input needed.
                </div>
            </div>
        `;
    }
    ...
    renderSlide5() {
        return html`
            <div class="slide slide-5 ${this.currentSlide === 4 ? 'active' : ''}">
                ...
                <div class="slide-content">
                    Manangry.ai is completely free to use. Just add your Gemini API key and start getting AI-powered assistance in your interviews
                    and meetings!
                </div>
            </div>
        `;
